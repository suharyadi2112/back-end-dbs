...
const validateNumberInput = (a, b, c) => {
    if (typeof a !== 'number' || isNaN(a)) {// cek jika argumen harus number
        throw new ValidationError("Argumen pertama harus number");
    }else if (typeof b !== 'number' || isNaN(b)) {// cek jika argumen harus number
        throw new ValidationError("Argumen kedua harus number");
    }else if (typeof c !== 'number' || isNaN(c)) {// cek jika argumen harus number
...
//   Missing expected exception (ValidationError): __TestError: validateNumberInput harus melempar ValidationError bila argumen ketiga bukan number